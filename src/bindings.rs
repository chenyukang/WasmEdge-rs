...
pub const WASMEDGE_VERSION: &'static [u8; 22usize] = b"0.8.2-rc.2-1-g76968fe\0";
...
pub const WasmEdge_ValType_WasmEdge_ValType_I32: WasmEdge_ValType = 127;
pub const WasmEdge_ValType_WasmEdge_ValType_I64: WasmEdge_ValType = 126;
pub const WasmEdge_ValType_WasmEdge_ValType_F32: WasmEdge_ValType = 125;
pub const WasmEdge_ValType_WasmEdge_ValType_F64: WasmEdge_ValType = 124;
pub const WasmEdge_ValType_WasmEdge_ValType_V128: WasmEdge_ValType = 123;
pub const WasmEdge_ValType_WasmEdge_ValType_FuncRef: WasmEdge_ValType = 112;
pub const WasmEdge_ValType_WasmEdge_ValType_ExternRef: WasmEdge_ValType = 111;
#[doc = " WASM Value type enumeration."]
pub type WasmEdge_ValType = u32;
pub const WasmEdge_RefType_WasmEdge_RefType_FuncRef: WasmEdge_RefType = 112;
pub const WasmEdge_RefType_WasmEdge_RefType_ExternRef: WasmEdge_RefType = 111;
#[doc = " WASM Reference type enumeration."]
pub type WasmEdge_RefType = u32;
pub const WasmEdge_Mutability_WasmEdge_Mutability_Const: WasmEdge_Mutability = 0;
pub const WasmEdge_Mutability_WasmEdge_Mutability_Var: WasmEdge_Mutability = 1;
#[doc = " WASM Mutability enumeration."]
pub type WasmEdge_Mutability = u32;
...
pub const WasmEdge_Proposal_WasmEdge_Proposal_BulkMemoryOperations: WasmEdge_Proposal = 0;
pub const WasmEdge_Proposal_WasmEdge_Proposal_ReferenceTypes: WasmEdge_Proposal = 1;
pub const WasmEdge_Proposal_WasmEdge_Proposal_SIMD: WasmEdge_Proposal = 2;
pub const WasmEdge_Proposal_WasmEdge_Proposal_TailCall: WasmEdge_Proposal = 3;
pub const WasmEdge_Proposal_WasmEdge_Proposal_Annotations: WasmEdge_Proposal = 4;
pub const WasmEdge_Proposal_WasmEdge_Proposal_Memory64: WasmEdge_Proposal = 5;
pub const WasmEdge_Proposal_WasmEdge_Proposal_Threads: WasmEdge_Proposal = 6;
pub const WasmEdge_Proposal_WasmEdge_Proposal_ExceptionHandling: WasmEdge_Proposal = 7;
pub const WasmEdge_Proposal_WasmEdge_Proposal_FunctionReferences: WasmEdge_Proposal = 8;
#[doc = " WASM Proposal enumeration."]
#[doc = " This enum is copied from \"include/common/configure.h\" and should be the"]
#[doc = " same."]
pub type WasmEdge_Proposal = u32;
pub const WasmEdge_HostRegistration_WasmEdge_HostRegistration_Wasi: WasmEdge_HostRegistration = 0;
pub const WasmEdge_HostRegistration_WasmEdge_HostRegistration_WasmEdge_Process:
    WasmEdge_HostRegistration = 1;
#[doc = " Host Module Registration enumeration."]
pub type WasmEdge_HostRegistration = u32;
#[doc = " Disable as many optimizations as possible."]
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_O0:
    WasmEdge_CompilerOptimizationLevel = 0;
#[doc = " Optimize quickly without destroying debuggability."]
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_O1:
    WasmEdge_CompilerOptimizationLevel = 1;
...
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_O2:
    WasmEdge_CompilerOptimizationLevel = 2;
#[doc = " Optimize for fast execution as much as possible."]
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_O3:
    WasmEdge_CompilerOptimizationLevel = 3;
...
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_Os:
    WasmEdge_CompilerOptimizationLevel = 4;
#[doc = " Optimize for small code size as much as possible."]
pub const WasmEdge_CompilerOptimizationLevel_WasmEdge_CompilerOptimizationLevel_Oz:
    WasmEdge_CompilerOptimizationLevel = 5;
#[doc = " AOT compiler optimization level enumeration."]
pub type WasmEdge_CompilerOptimizationLevel = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    #[doc = " Copy and set data into a memory instance."]
    #[doc = ""]
    #[doc = " \\param Cxt the WasmEdge_MemoryInstanceContext."]
